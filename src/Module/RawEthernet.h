...
private:
    ...
    int constructing_ethernet_header(struct ethhdr *const ethernet_header, const uint64_t dest_addr, const uint16_t data_len);
    ...
    RawEthernet(const RawEthernet &) = delete; // запрещаем конструктор копирования
